...
// In the browser we use the public env var; on the server we hit the backend directly.
// Always falls back to the production API if no env is provided.
const API_BASE_URL =
  process.env.NEXT_PUBLIC_API_BASE_URL || 'https://api.thetechnextdoors.com/api';
